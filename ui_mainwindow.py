...
"}")
        ...
        self.actionImport_Data.setFont(font1)
        ...
        icon2 = QIcon()
        icon2.addFile(u"icons/Free simple line mix/PNG/64/3213270 - communication email letter mail message sent.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionExport_Cashflow.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u"icons/Free simple line mix/PNG/64/3213304 - bank business money research search.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"resources/4288576 - and application internet seo technology web website.png", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget.addTab(self.tabMainMenu, icon4, "")
        ...
        icon5 = QIcon()
        icon5.addFile(u"resources/4288598 - analysis analytics chart data pie.png", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget.addTab(self.tabForecasting, icon5, "")
        ...
        icon6 = QIcon()
        icon6.addFile(u"resources/4288590 - objective sight target view vision.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.tabWidget.addTab(self.tabCashflow, icon7, "")
    ...
    def retranslateUi(self, main_window):
        ...
        self.label.setText(QCoreApplication.translate("main_window", u"<html><head/><body><p><span style=\" font-size:22pt; font-weight:600;\">Welcome!</span></p><p>You need to import production data to get started. </p><p>Refer to the documentation to get started.</p><p>Use at your own discretion. </p><p>This application is open source to provide useful software to engineers and evaluators. </p><p>PetroAlchemy will never require a subscription or fee to use.</p></body></html>", None))
