...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u"resources/2850901 - document file page paper upload.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"resources/2850900 - document download file page paper.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"resources/3213304 - bank business money research search.png", QSize(), QIcon.Normal, QIcon.Off)
