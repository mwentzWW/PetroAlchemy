...
"}")
        ...
        self.actionCheck_for_updates.setFont(font)
        ...
        self.actionExport_Cashflow.setFont(font)
        ...
        self.tabWidget.addTab(self.tabProductionPlots, icon5, "")
        ...
        self.tableViewCashflow.setFont(font6)
        ...
        self.tabWidget.addTab(self.tabCashflowSetup, icon7, "")
